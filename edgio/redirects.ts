export default [
  ...
  ['/guides/v4_getting_started', '/guides/webapp_cdn_getting_started'],
  ['/guides/v4_performance', '/guides/routing'],
  ['/guides/v4_sites', '/guides/connectors'],
  ['/guides/v4_security', '/guides/security'],
  ['/guides/v4_environments', '/guides/environments'],
  ['/guides/v4_integrations', '/guides/integrations'],
  ['/guides/v4_accounts_teams', '/guides/alerts'],
  ['/guides/v4_developer_tools', '/guides/cli'],
  ['/guides/v4_apis', '/guides/rest_api'],
  ['/guides/v4_reference', '/guides/limits'],
];
