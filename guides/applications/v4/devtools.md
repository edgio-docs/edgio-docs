...
Then, if you haven't already, enable `{{ PACKAGE_NAME }}/prefetch` in your service worker. See [Prefetching]({{ DOCS_URL }}/applications/prefetching) for more information on enabling `{{ PACKAGE_NAME }}/prefetch`.
