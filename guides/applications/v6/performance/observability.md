...
- The value of this header will be logged into `xut` field in [access logs](/applications/develop/logs#access-logs). The logged data is limited to 50 bytes after which it will be truncated.
