...
Each environment for paying customers may have up to 10 online deployments, while free customers are restricted to 3 online deployments. If you are using CDN-as-code, then you may use the permalink associated with any online deployment to test your site.
