...
1.  Create an environment.
    ...
    ![Current Site Environment](/images/v7/iterative-migration-create-env-current-site.png)

2.  Deploy your changes. 
3.  Verify your website's functionality using a URL generated by the deployment.

    ![Latest Deployment](/images/v7/latest-deployment.png)
...
2.  Create an origin configuration that points to the `current-site` environment. 
    ...
    4.  From the entry environment's **Origins** page, create an origin configuration. 
        ...
        ![current-site Origin Configuration](/images/v7/iterative-migration-origin-current-site.png)
...
4.  Create an experiment.
    ...
    1.  Configure the first variant to:
        ...
        -   Set the origin to `current-site`.
            ...
            ![Set Origin Feature](/images/v7/iterative-migration-experiment-set-origin-current.png?height=357)

    2.  Configure the second variant to:
        -   Receive 10% of the site's traffic. 
        -   Set the origin to `new-site`.

            ![Set Origin Feature](/images/v7/iterative-migration-experiment-set-origin-new.png?height=357)

        Your experiment should look similar to the following illustration:
    
        ![Experiment](/images/v7/iterative-migration-experiment.png?width=650)
...
![Experiment](/images/v7/iterative-migration-experiment-2.png?width=650)
