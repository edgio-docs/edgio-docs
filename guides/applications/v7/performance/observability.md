...
-   If you are using our CDN-as-code approach to CDN configuration, then you may use our [DevTools](/guides/performance/observability/developer_tools_chrome_extension) to monitor the impact of your caching and predictive prefetching configurations on your site in real time. This allows use to identify and remediate issues.
