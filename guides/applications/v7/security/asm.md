...
5.  Perform one of the following steps:
    ...
    -   **Tenable Nessus:**
        ...
        4.  If you're using a self-signed certificate, uncheck the **Verify Cert** option to disable certificate verification but keep in mind that this is not recommended for production environments.
