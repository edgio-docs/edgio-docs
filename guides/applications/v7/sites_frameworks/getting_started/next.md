...
| `turbopack`                  | Enables the TurboPack bundler instead of the default Webpack when running your Next.js app in development mode. This option requires Next.js 13 or later.                                                                                          | `false` |
