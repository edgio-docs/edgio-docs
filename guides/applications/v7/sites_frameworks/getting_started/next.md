...
| `disablePreviewMode`         | Disables the rule for [a preview mode](https://nextjs.org/docs/pages/building-your-application/configuring/preview-mode) that allows to bypass edge cache and pre-rendered pages when it's enabled.                                    | `false` |
