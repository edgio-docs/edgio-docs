...
<Info>This content refers to Caching and Delivery v2. For legacy Caching and Delivery (v1), see the [Control Caching and Delivery v1 User Guide](/assets/delivery/v1_user_guide.pdf)</Info>
