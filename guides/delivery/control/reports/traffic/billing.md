...
<Callout type="info">Due to data filtering and proration, data in the Billing report may not align with data in other individual reports. For more information, see [Filtering of Late-Arriving Data Dashboard](/delivery//control/reports/general_information/general_information/#filtering-of-late-arriving-data).</Callout>
