...
**![{"color": "orange"}](/ 'Layer0 recommends utilizing this rule group for all WAF use cases.')**
...
**![{"color": "green"}](/ 'Layer0 recommends enabling the 'Bad Input - Log4J' rule on all WAF applications.')**
