...
- You may import settings from a file. We support the following formats:
  - **Text File**: Import a file that uses the same format as a Live Slicer configuration file. Specify each [desired setting](#configuration-settings) on a separate line.
