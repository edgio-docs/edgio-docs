...
### SCTE 35/104 Signal Processing  {/*scte*/}
...
- **Live Slicer API**: Assign metadata to a particular asset through the [`add_meta` method](https://docs.edgecast.com/video/Content/Develop/Live-Slicer-API.htm#addmeta).
...
### Audio Channel Layout (SDI Signal)  {/*audio-channel-layout*/}

The Live Slicer may be configured to use either Standard or Custom audio channel layouts.

#### Standard Layout (SDI Signal)  {/*standard-layout*/}
...
#### Custom Audio Layout (SDI Signal)  {/*custom-audio-layout*/}
...
##### Multiple Track Setup  {/*multiple-track-setup*/}
