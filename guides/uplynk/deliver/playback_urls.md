...
### External ID (Asset)  {/*external-id-asset*/}
...
See [General Parameter descriptions](/uplynk/deliver/playback_urls/customize_playback_via_parameters#general_parameters) for more information.
...
- [Learn more about virtual linear playlists and Smartstart](/uplynk/manage/assets/virtual_linear_playlists_and_smartstart).
...
- [Signature parameter](#digital-signature): Append the `sig` parameter to the end of the query string to digitally sign the playback URL based off of the specified core identification and customization parameters.
