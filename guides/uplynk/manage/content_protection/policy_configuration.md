...
3. Leverage an [expansion parameter](/uplynk/deliver/playback_urls/#core-identification-parameters) to shorten the query string and to obfuscate the Studio DRM policy being applied.
