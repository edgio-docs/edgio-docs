...
3. [**Configure the Live Slicer**](#configure-communication-with-amazon-sns) to push health notifications to an Amazon SNS topic.
...
## Subscribing to an SNS Topic via Amazon Lambda
