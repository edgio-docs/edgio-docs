...
| Debug Name | Filters ad job data by tagged playback session(s).<br />Tag a playback session by passing the [`ad._debug` parameter](/uplynk/deliver/playback_urls/#general-parameters) in the playback URL. |
