...
input_file_path = "./dist/partner_rest_api.html"  # Replace with your input file path
output_file_path = "./dist/partner_rest_api.html"  # Replace with your output file path
