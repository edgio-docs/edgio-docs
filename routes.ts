    ...
    if (isProductionBuild()) {
      ...
      setResponseHeader(
        ...
        [
          ...
          `img-src 'self' www.google-analytics.com analytics.twitter.com www.facebook.com px.ads.linkedin.com *.intercomcdn.com tr.lfeeder.com data: *.moovweb.net *.clarity.ms *.bing.com`,
