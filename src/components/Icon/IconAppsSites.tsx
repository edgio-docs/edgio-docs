...
export const IconAppsSites = React.memo<JSX.IntrinsicElements['svg']>(
  ({className}) => (
    <svg
...
export const IconAppsSitesDark = React.memo<JSX.IntrinsicElements['svg']>(
  ({className}) => (
    <svg
      className={cn('inline', className)}
      width="32"
...
IconAppsSites.displayName = 'Icon';
IconAppsSitesDark.displayName = 'IconDark';
