...
export const IconJekyll = React.memo<JSX.IntrinsicElements['svg']>(
  ({ className }) => (
    <svg className={cn('inline', className)} viewBox="0 0 512 512">
      ...
      />
      <g fill="#FFF">
        <circle opacity="0.5" cx="226.531" cy="261.806" r="3.506" />
        <circle opacity="0.5" cx="249.514" cy="287.227" r="5.285" />
        <circle opacity="0.5" cx="214.429" cy="317.459" r="9.915" />
        <circle opacity="0.5" cx="198.375" cy="335.795" r="5.286" />
        <circle opacity="0.5" cx="219.43" cy="375.008" r="3.506" />
      </g>
    </svg>
  )
);
