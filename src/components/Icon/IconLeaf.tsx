...
export const IconLeaf = React.memo<JSX.IntrinsicElements['svg']>(
...
export const IconLeafDark = React.memo<JSX.IntrinsicElements['svg']>(
  function IconLeafDark({className}) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
