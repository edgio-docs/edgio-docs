...
export const IconSanity = React.memo<JSX.IntrinsicElements['svg']>(
  ({className}) => (
...
export const IconSanityDark = IconSanity;

IconSanity.displayName = 'IconSanity';
IconSanityDark.displayName = 'IconSanityDark';
