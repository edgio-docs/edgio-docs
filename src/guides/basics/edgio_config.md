...
|--------------------------------------------|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `name`                                     | string   | (Required) The origin name refered within the {{ ROUTES_FILE }}.                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `hosts`                                    | object[] | An array of origin host objects for which to connect to when proxying requests.                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `shields.global`                           | string   | The POP code for the global shield.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
