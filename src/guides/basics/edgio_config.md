...
The `origins` config is an Object[] whose keys are:

| Property                                   | Type     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|--------------------------------------------|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `name`                                     | String   | (Required) The origin name refered within the {{ ROUTES_FILES }}.                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `hosts`                                    | Object[] | An array of origin hosts for which to connect                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| `shields`                                  | Object   | A map of shield names to data center codes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `shields.global`                           | String   | The data center code for the global shield.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `shields.apac`                             | String   | The data center code for the Asia Pacific shield.                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `shields.emea`                             | String   | The data center code for the Europe, Middle East, and Africa shield.                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `shields.us_west`                          | String   | The data center code for the US West shield.                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `shields.us_east`                          | String   | The data center code for the US East shield.                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
