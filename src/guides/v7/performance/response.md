...
| 404 Not Found                                                 | The server cannot find the requested resource. [View troubleshooting information.](/guides/performance/troubleshooting#404-not-found)

                                                                                                                                                                                                                                                                                                                                                                         |
| 412 Precondition Failed                                       | The requested content was not prefetched because it was not cached on the POP closest to the client. {{ PRODUCT }} only serves prefetch requests for cached content. 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 505 HTTP Version Not Supported                                | Indicates that an invalid HTTP protocol or version was requested.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 530 Internal {{ PRODUCT }} Error                         | Unexpected error. {{ CONTACT_SUPPORT }} immediately.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| 533 Project Upstream TLS Error                                | There was an error negotiating a secure TLS connection with the origin. Common causes are the host name provided does not match the name in the upstream TLS certificate, or the upstream TLS certificate has expired.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| 535 Unknown Project                                           | The HTTP `host` header is missing or does not match any {{ PRODUCT }} deployment. Check your requesting URL and your project configuration.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| 538 Project Request Loop                                      | The {{ PRODUCT }} project exceeded the maximum level (3) of nested {{ PRODUCT }} requests. "Nested" means an {{ PRODUCT }} site is the upstream of itself or of another {{ PRODUCT }} site.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [539 Project Timeout](/guides/performance/troubleshooting#troubleshooting-539-status-codes)                                           | This status code is primarily caused by timeouts, but can also be caused by lack of allowlists (whitelists) configured on your backend server. |
...
| 542 Project Header Overflow                                   | The {{ PRODUCT }} project's request or response had too many HTTP headers. [View request limits.](/guides/performance/limits#request-and-response-limits).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 543 Global Upstream Timeout                                   | The request failed to propagate between {{ PRODUCT }} edge and the Origin Shield POP.  {{ CONTACT_SUPPORT }}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
