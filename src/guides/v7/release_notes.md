...
| 9/26/2023 | **{{ PRODUCT }} Sites:**  <ul><li>Added support for the `outputFileTracingRoot` config option of Next.js into [@edgio/next](https://www.npmjs.com/package/@edgio/next) connector version 7.2.7 which allows to build the latest Next.js v13.x projects in NPM/YARN workspaces with dependencies from the workspace.</li></ul> |
