...
This guide shows you how to deploy a [Eleventy](https://www.11ty.dev/) application on Layer0.

## Example

[Try the Eleventy Example Site](https://layer0-docs-layer0-eleventy-example-default.layer0-limelight.link?button)
[View the Code](https://github.com/layer0-docs/layer0-eleventy-example?button)
[Deploy to Layer0](https://app.layer0.co/deploy?button&deploy&repo=https://github.com/layer0-docs/layer0-eleventy-example)
...
## Configuring your Eleventy app for Layer0
...
### Run the Eleventy app locally on Layer0
