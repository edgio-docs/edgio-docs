...
This guide shows you how to deploy the [Next.js Commerce](https://github.com/vercel/commerce) starter kit on Layer0. Note that Next.js Commerce is currently under development and requires an account on the [BigCommerce](https://www.bigcommerce.com/) platform.

## Next.js Commerce Example

Here is an example of the [Next.js Commerce](https://nextjs.org/commerce) template running on Layer0. It uses all of the latest Next.js 10 features
...
1. Register for a free account on the [Layer0 sign up page]({{ APP_URL }}/signup).
...
For more details on using Next.js on Layer0 refer to the [Next.js Guide](next).
...
2. Install the Layer0 [CLI](cli) globally
...
4. Run Layer0 `init` in the project directory:
...
An [example `.env.local` file](https://github.com/layer0-docs/layer0-nextjs-commerce-example/blob/master/.env.local) is in the the Layer0 examples repo.
