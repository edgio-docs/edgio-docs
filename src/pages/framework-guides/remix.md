...
This guide shows you how to deploy a [Remix](https://remix.run/) application on Layer0.
...
Deploying requires an account on Layer0. [Sign up here for free.]({{ APP_URL }}/signup).
