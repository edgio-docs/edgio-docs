...
This guide shows you how to deploy a [Shopify Hydrogen](https://hydrogen.shopify.dev/) application on Layer0.
...
## Configuring your Shopify Hydrogen app for Layer0
...
### Run the Shopify Hydrogen app locally on Layer0
