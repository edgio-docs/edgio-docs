...
This guide shows you how to deploy a [Vue.js](https://vuejs.org/) application on Layer0.
...
For the Vue `hello-world` template, replace the `routes.js` file that was created during `0init` with the following:
...
For server side rendered Vue.js apps we recommend using the Nuxt.js framework which is supported on Layer0. Refer to the [Nuxt](nuxt) guide for more information.
