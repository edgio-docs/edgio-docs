...
[Deploy to Layer0](https://app.layer0.co/deploy?button&deploy&repo=https%3A%2F%2Fgithub.com%2Flayer0-docs%2Flayer0-angular-example)
...
#### 1. Install {{ PRODUCT_NAME }} CLI globally: {/*1-install--product_name--cli-globally*/}
