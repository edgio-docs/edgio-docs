...
## Configuring your Brunch app for {{ PRODUCT_NAME }} {/*configuring-your-brunch-app-for-layer0*/}
...
### Run the Brunch app locally on {{ PRODUCT_NAME }} {/*run-the-brunch-app-locally-on-layer0*/}
