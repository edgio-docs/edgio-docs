...
Then, if you haven't already, enable `{{ PACKAGE_NAME }}/prefetch` in your service worker. See [Prefetching](prefetching) for more information on enabling `{{ PACKAGE_NAME }}/prefetch`.
