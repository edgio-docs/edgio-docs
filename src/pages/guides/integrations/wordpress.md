...
### Create via {{ PORTAL_PLAIN }} {/*create-via-developer-console*/}
...
To obtain the **API Key**, go to your site within the [{{ PORTAL_PLAIN }}]({{ LOGIN_URL }}). Click **Settings > Create new Deploy Token** and enter in a name for the token.
