...
## Configuring your Ionic Vue app for {{ PRODUCT_NAME }} {/*configuring-your-ionic-vue-app-for-layer0*/}
...
### Run the Ionic Vue app locally on {{ PRODUCT_NAME }} {/*run-the-ionic-vue-app-locally-on-layer0*/}
