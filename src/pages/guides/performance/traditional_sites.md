...
3. Create a CNAME record with your DNS provider with the value shown under the _Domain Configuration_ tab for the environment in the {{ PRODUCT_NAME }} Console.
