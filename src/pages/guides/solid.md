...
## Configuring your SolidJS app for {{ PRODUCT_NAME }} {/*configuring-your-solidjs-app-for-layer0*/}
...
### Run the SolidJS app locally on {{ PRODUCT_NAME }} {/*run-the-solidjs-app-locally-on-layer0*/}
