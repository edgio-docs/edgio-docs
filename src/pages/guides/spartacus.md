...
#### 1. Install the {{ PRODUCT_NAME }} CLI globally: {/*1-install-the-{{PRODUCT_NAME_LOWER}}-cli-globally*/} {/*1-install-the--product_name--cli-globally-1-install-the-product_name_lower-cli-globally*/}
